...
```bash
curl -L -X POST http://43.156.26.92:8892/api/v1/auth/verify \
...
```bash
curl -L -X POST http://43.156.26.92:8892/api/v1/generate/image \
  -H "Content-Type: application/json" \
  -H "X-API-KEY: vk_xxx" \
  -d '{
...
```bash
curl -L -X POST http://43.156.26.92:8892/api/v1/generate/video \
  -H "Content-Type: application/json" \
  -H "X-API-KEY: vk_xxx" \
...
```bash
curl -L -X POST http://43.156.26.92:8892/api/v1/workflows/2603-wf-anime-production/run \
  -H "Content-Type: application/json" \
  -H "X-API-KEY: vk_xxx" \
